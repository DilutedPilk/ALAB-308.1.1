...
console.log(`Are the four numbers within criteria? : ${isValid}`);
...
console.log(`Are all numbers divisible by 5? : ${first_check}`);

// checks if n1 is larger than n4

const second_check = n1 > n4;

console.log(`Is the first number larger than the last number? : ${second_check}`);
